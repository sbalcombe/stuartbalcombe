...
const QuoteWrapper = styled.div`
  ${tw`border-solid border-l-4 border-t-0 border-b-0 border-r-0 border-indigo-light bg-white px-4 flex flex-col justify-between leading-normal my-12`};
`
...
const QuoteText = styled.p`
  ${tw`text-grey-darker text-sm mb-2`};
`
