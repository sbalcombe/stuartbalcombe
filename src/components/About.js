  ...
  render() {
    return (
      ...
      >
	        ...
	        <p style={{ textAlign: 'justify' }}>Hi there, I'm Stuart. I've spent the past 2 and half years building products and helping companies grow. I'm currently Director of Product at <a href='https://www.letssail.co' target='_blank'>Sail</a> and previously led growth at <a href='http://www.betaspring.com' target='_blank'>Betaspring</a>, I take an experience-first approach to helping businesses understand customer problems and design solutions to make their users successful.</p>
