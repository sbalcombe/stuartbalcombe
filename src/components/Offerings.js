...
export default function Offerings (props) {
	return (
		<div>
			...
			<p><Link to='/custom-product-design'><strong>Custom Product Design (Starting at $1500 / month)</strong></Link> – Redesign an existing feature or a create a new product. We'll quickly validate your ideas with rapid prototyping and user testing.</p>
			<hr />
